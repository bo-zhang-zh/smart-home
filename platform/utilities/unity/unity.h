...
#define TEST_ABORT() {longjmp(Unity.AbortFrame, 1);}
    ...
    #ifdef UNITY_SHOW_TEST_FILE_PATH
        #define RUN_EXAMPLE_EX(setUpFunc, func, tearDownFunc, caseId) UnityDefaultTestRun(setUpFunc, func, tearDownFunc, #func, caseId, __FILE__)
    #else
        #define RUN_EXAMPLE_EX(setUpFunc, func, tearDownFunc, caseId) UnityDefaultTestRun(setUpFunc, func, tearDownFunc, #func, caseId)
    #endif
#endif
...
#define FSL_TEST(testCase, message, assertWithoutTEST, param...)    SET_INDEP_ASSERT_ID(testCase, __LINE__);\
    TEST_##assertWithoutTEST(param)

/* Remove unused ## to fix gcc build error*/
#define FSL_TEST_ASSERT(testCase, message, assertWithoutTEST_ASSERT, param...)  SET_INDEP_ASSERT_ID(testCase, __LINE__);\
